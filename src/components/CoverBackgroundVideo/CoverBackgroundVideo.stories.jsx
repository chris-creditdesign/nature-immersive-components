...
export default {
	title: "CoverBackgroundVideo",
	component: CoverBackgroundVideo,
};

export const Default = () => (
	<CoverBackgroundVideo src="video/video.jpg" alt="This is the alt text">
		<Heading
			className="centered"
			author={data.author}
...
export const WithTextAboveAndBelow = () => (
	<LayoutStack stackSpace="var(--s2)">
		<LayoutCenter>
			<p>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Blanditiis
        quam nostrum molestias quisquam eligendi distinctio. Itaque enim amet
        dolor minima assumenda suscipit quos soluta eos debitis perferendis!
        Hic, cum ipsum!
			</p>
			<p>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Blanditiis
