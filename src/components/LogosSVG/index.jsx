...
const NatureLogoSVG = ({ className, height, title, titleId }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 200 49"
		role="img"
	...
	>
		...
		<g>
			<path d="M12.8 8.4l.1.1v8.4h.2c1.7-4.8 6-8.7 12.2-8.7 8.1 0 10.5 4 10.5 11.7v15.2c0 4.6.3 9.4 1.4 13h-13c1.1-3.4 1.2-7.6 1.2-12.6V21.1c0-3.5-1.4-5.2-5.3-5.2-3 0-5.2.8-6.9 2.3v17.4c0 5 .1 9.2 1.2 12.6H1.5c1.2-3.6 1.4-8.4 1.4-13V21.1c0-3.8-1.4-7.2-3-9l12.9-3.7" />
			<path d="M59.8 40.7V26.5c-.8 1.2-1.8 1.9-4.7 3.2-3.7 1.8-5 3.8-5 7.9 0 3.4 1.9 5.6 4.9 5.6 3 .1 4-1 4.8-2.5zM56.4 8.3c10.1 0 13.8 4 13.8 12.2v17.2c0 3.1 1.2 4 3.7 4 .4 0 1.7-.2 2.1-.6-.2 1.2-.4 1.8-.6 2.5-1.2 3.4-3.3 5.4-7.5 5.4-5 0-7.5-3.5-7.6-7.1h-.1c-1.7 5-4.9 7.1-10 7.1-6.3 0-10.3-3.8-10.3-9.7 0-6.2 5.6-8.9 11.5-11.2 5.6-2.2 8.6-3.8 8.6-7.8v-.8c0-4.4-1.4-6.6-5.5-6.6-2.6 0-3.5 1.2-4.1 3.7-.8 3.8-2.3 5.1-4.8 5.1-2.2 0-4.3-1.5-4.3-4.3-.2-5.4 7.3-9.1 15.1-9.1z" />
			<path d="M98.7 43.9C97.4 47 94.1 49 89.4 49c-8 0-11.1-4-11.1-11.4v-23h-3.8v-.3L88.4 0l.2.1v9.1h10l-1 5.5h-8.9V36c0 4.1 1.7 5.7 5.4 5.7 2.8 0 4.3-.4 5.6-1.1-.3 1.4-.5 2.2-1 3.3" />
			<path d="M113.1 8.9v27c0 4 1.6 6.3 5.5 6.3 3.3 0 5.8-1.1 7.2-3V20.9c0-4-.4-7.4-1.7-10.8l12-1.2v27.6c0 6.1.6 8.8 1.6 11.7H126v-7.8h-.1c-1.7 5-4.9 8.6-11.6 8.6-8.5 0-11.6-5.1-11.6-12.8V20.9c0-4-.4-7.4-1.7-10.8l12.1-1.2" />
			<path d="M152.5 18.3c1.7-7.2 5-10 9.4-10 4 0 6.1 2.1 6.1 5.4 0 3-1.7 5.4-4.8 5.4-1.8 0-2.9-.8-3.7-1.6-.9-.8-1.5-1.7-2.4-1.7-2.1 0-4.4 3.5-4.4 9.4V35c0 4.8.4 9.6 1.3 13.2h-13c1.2-3.6 1.4-8.4 1.4-13V21.1c0-3.8-1.4-7.2-3-9l12.8-3.7.1.1v9.8h.2" />
			<path d="M177.2 24l13.1-1.2c-.1-6.2-1.1-9.9-5.4-9.9-4.4.1-7 3.6-7.7 11.1zm7.8 25c-10 0-18.2-6.6-18.2-19.3 0-12.9 7.9-21.5 18.5-21.5 10.1 0 14.8 6.4 14.8 18.5h-22.9v1.2c0 9.7 5 13.6 11.9 13.6 6.2 0 9-2.5 10.8-4.3l.2.6C198.3 43.6 193.7 49 185 49z" />
		</g>
	</svg>
)
...
const SpringerNatureLogoSVG = ({ className, height, titleId, title }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 140 14"
		role="img"
...
const NatureBriefingLogoSVG = ({ className, height, titleId, title }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 200 34"
		role="img"
...
const FacebookLogoSVG = ({ height, title, titleId }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 30 30"
		focusable="false"
	...
	>
		<title id={titleId}>{title}</title>
		<path d="M30,15A15,15,0,1,1,15,0,15,15,0,0,1,30,15ZM15,2A13,13,0,1,0,28,15,13,13,0,0,0,15,2Z" />
...
const TwitterLogoSVG = ({ height, title, titleId }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 30 30"
		focusable="false"
...
const EmailLogoSVG = ({ height, title, titleId }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 30 30"
		focusable="false"
...
const VeggieBurgerLogoSVG = ({ height, title, titleId }) => (
	<svg
		height={`${height}em`}
		viewBox="0 0 30 30"
		focusable="false"
	...
	>
		<title id={titleId}>{title}</title>
		<g id="closed">
			<path d="M27,6H3C1.34,6,0,4.66,0,3v0c0-1.66,1.34-3,3-3h24c1.66,0,3,1.34,3,3v0C30,4.66,28.66,6,27,6z" />
			<path d="M27,30H3c-1.66,0-3-1.34-3-3v0c0-1.66,1.34-3,3-3h24c1.66,0,3,1.34,3,3v0C30,28.66,28.66,30,27,30z" />
			<path d="M27,17.5H3c-1.66,0-3-1.34-3-3v0c0-1.66,1.34-3,3-3h24c1.66,0,3,1.34,3,3v0C30,16.16,28.66,17.5,27,17.5z" />
		</g>
		<g id="open" hidden>
			<path d="M19.24,14.5l8.51-8.51c1.17-1.17,1.17-3.07,0-4.24s-3.07-1.17-4.24,0L15,10.26L6.49,1.75c-1.17-1.17-3.07-1.17-4.24,0 s-1.17,3.07,0,4.24l8.51,8.51l-8.51,8.51c-1.17,1.17-1.17,3.07,0,4.24s3.07,1.17,4.24,0L15,18.74l8.51,8.51 c1.17,1.17,3.07,1.17,4.24,0s1.17-3.07,0-4.24L19.24,14.5z" />
		</g>
	</svg>
)
